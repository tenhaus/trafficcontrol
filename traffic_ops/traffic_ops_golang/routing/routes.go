...
import (
	...
	"github.com/apache/trafficcontrol/ops/apicapability"
	"github.com/apache/trafficcontrol/ops/apitenant"
	"github.com/apache/trafficcontrol/ops/asn"
	"github.com/apache/trafficcontrol/ops/auth"
	"github.com/apache/trafficcontrol/ops/cachegroup"
	"github.com/apache/trafficcontrol/ops/cachegroupparameter"
	"github.com/apache/trafficcontrol/ops/cachesstats"
	"github.com/apache/trafficcontrol/ops/capabilities"
	"github.com/apache/trafficcontrol/ops/cdn"
	"github.com/apache/trafficcontrol/ops/cdnfederation"
	"github.com/apache/trafficcontrol/ops/coordinate"
	"github.com/apache/trafficcontrol/ops/crconfig"
	"github.com/apache/trafficcontrol/ops/crstats"
	"github.com/apache/trafficcontrol/ops/dbdump"
	"github.com/apache/trafficcontrol/ops/deliveryservice"
	"github.com/apache/trafficcontrol/ops/deliveryservice/consistenthash"
	dsrequest "github.com/apache/trafficcontrol/ops/deliveryservice/request"
	"github.com/apache/trafficcontrol/ops/deliveryservice/request/comment"
	dsserver "github.com/apache/trafficcontrol/ops/deliveryservice/servers"
	"github.com/apache/trafficcontrol/ops/deliveryservicerequests"
	"github.com/apache/trafficcontrol/ops/deliveryservicesregexes"
	"github.com/apache/trafficcontrol/ops/division"
	"github.com/apache/trafficcontrol/ops/federation_resolvers"
	"github.com/apache/trafficcontrol/ops/federations"
	"github.com/apache/trafficcontrol/ops/hwinfo"
	"github.com/apache/trafficcontrol/ops/invalidationjobs"
	"github.com/apache/trafficcontrol/ops/iso"
	"github.com/apache/trafficcontrol/ops/login"
	"github.com/apache/trafficcontrol/ops/logs"
	"github.com/apache/trafficcontrol/ops/origin"
	"github.com/apache/trafficcontrol/ops/parameter"
	"github.com/apache/trafficcontrol/ops/physlocation"
	"github.com/apache/trafficcontrol/ops/ping"
	"github.com/apache/trafficcontrol/ops/plugins"
	"github.com/apache/trafficcontrol/ops/profile"
	"github.com/apache/trafficcontrol/ops/profileparameter"
	"github.com/apache/trafficcontrol/ops/region"
	"github.com/apache/trafficcontrol/ops/role"
	"github.com/apache/trafficcontrol/ops/routing/middleware"
	"github.com/apache/trafficcontrol/ops/server"
	"github.com/apache/trafficcontrol/ops/servercapability"
	"github.com/apache/trafficcontrol/ops/servercheck"
	"github.com/apache/trafficcontrol/ops/servercheck/extensions"
	"github.com/apache/trafficcontrol/ops/servicecategory"
	"github.com/apache/trafficcontrol/ops/staticdnsentry"
	"github.com/apache/trafficcontrol/ops/status"
	"github.com/apache/trafficcontrol/ops/steering"
	"github.com/apache/trafficcontrol/ops/steeringtargets"
	"github.com/apache/trafficcontrol/ops/systeminfo"
	"github.com/apache/trafficcontrol/ops/topology"
	"github.com/apache/trafficcontrol/ops/trafficstats"
	"github.com/apache/trafficcontrol/ops/types"
	"github.com/apache/trafficcontrol/ops/urisigning"
	"github.com/apache/trafficcontrol/ops/user"
	"github.com/apache/trafficcontrol/ops/vault"
...
func Routes(d ServerData) ([]Route, []RawRoute, http.Handler, error) {
	...
	routes := []Route{
		...
		{api.Version{3, 0}, http.MethodPut, `service_categories/{name}/?$`, api.UpdateHandler(&servicecategory.TOServiceCategory{}), auth.PrivLevelOperations, Authenticated, nil, 306369141, noPerlBypass},
